...
export const Sidebar = ({ isOpen, onClose }) => {
    ...
    return (
        <>
            ...
            <aside className={cn(
                "w-[280px] lg:w-[240px] h-screen fixed left-0 top-0 bg-sidebar border-r border-border flex flex-col text-sm z-40 transition-transform duration-300",
                        ...
                        {NAV_BASE.map((item) => (
                            <NavLink
                                ...
                                className={({ isActive }) => cn(
                                    "flex items-center gap-2 px-3 py-2 rounded-md transition-colors mb-0.5",
                                    isActive
